export const projects = [
  {
    ...
    tasks: [
      ...
      "Wireframes gemaakt",
      "React Native Expo-project opgezet",
      "Login-, registratie- en homepagina gebouwd",
      "Unity-game gehost op Netlify",
  ...
  },
  {
    ...
    subtitle: "Branding voor een DJ & Producer",
    ...
    tasks: [
      ...
      "Bijgedragen aan social media templates",
      "Visuele identiteit versterkt",
    ],
    learned:
  ...
  },
  {
    slug: "cz-zorgvinder",
    title: "CZ Zorgvinder",
    subtitle: "UX Design voor toegang tot mentale zorg",
    ...
    tech: ["UX-Research", "Prototype", "Wireframes", "User Testing", "README"],
    tasks: [
      "Projectplan opgesteld",
      "Contact gelegd met externe partijen",
      "Observatiescenario’s opgezet",
      "Enquête en observaties uitgevoerd",
      "Wireframes en conceptideeën ontworpen",
      "README en documentatie geschreven",
    ],
    learned:
